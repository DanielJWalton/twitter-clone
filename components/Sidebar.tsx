...
const Sidebar =({tweets: tweetsProp}: Props) =>{
  ...
  return (
    <div className="col-span-2 overflow-y-scroll scrollbar-hide mx-auto hidden flex-col items-center px-4 sm:col-span-1 md:col-span-2 md:inline-flex md:items-start">
      <img
